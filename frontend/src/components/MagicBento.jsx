...
const DEFAULT_GLOW_COLOR = '80, 200, 120';
...
const cardData = [
    {
        ...
        description: 'Millisecond synchronization for battle without latency.',
        label: 'STABLE'
    },
    {
        color: '#030014',
        title: 'Tech Arena',
        description: 'Focused on JS, React, and Fullstack engines.',
        label: 'CURATED'
    },
    {
        color: '#030014',
        title: 'Emerald HUD',
        description: 'Futuristic UI designed for high-level focus.',
        label: 'INTERFACE'
    },
    {
        color: '#030014',
        title: 'Global Ranking',
        description: 'Persistent scoring integrated with MySQL.',
        label: 'MMR'
    },
    {
        color: '#030014',
        title: 'Neural Link',
        description: 'Low-latency socket connections for instant debriefing.',
        label: 'SOCKET'
    },
    {
        color: '#030014',
        title: 'Security',
        description: 'Enterprise-grade protection for your mission data.',
        label: 'SECURE'
    }
];
